...
function s.thfilter2(c,lv)
  return c:IsSetCard(SET_HN) and c:IsType(TYPE_MONSTER) and c:GetLevel()==lv and c:IsAbleToHand()
end
...
function s.thop(e,tp,eg,ep,ev,re,r,rp)
  ...
  local g2=Duel.SelectMatchingCard(tp,s.thfilter2,tp,LOCATION_DECK,0,1,1,nil,g1:GetFirst():GetLevel())
